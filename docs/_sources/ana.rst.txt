...
E' possibile scaricare i metadati conformi al profilo DCAT-AP_IT per questa basi di dati in :download:`RDF/Turtle <Metadati/metadatiDCATAPIT_ANA.ttl>`, :download:`RDF/XML <Metadati/metadatiDCATAPIT_ANA.rdf>` e :download:`JSON-LD <Metadati/metadatiDCATAPIT_ANA.jsonld>` (essendo questa una fotografia di quanto disponibile alla data di pubblicazione delle presenti schede, la data di ultimo aggiornamento indicata nei file è quella della pubblicazione stessa delle schede).
